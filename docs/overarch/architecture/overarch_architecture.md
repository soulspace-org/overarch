...
|---|---|
| [Domain Specific Language](../../overarch/architecture/goal/domain-specific-language.md) | Overarch shall not a implement a domain specific language for architecture modeling. |
| [Fancy UI](../../overarch/architecture/goal/fancy-ui.md) | Overarch shall not provide a fancy UI. |
