(ns org.soulspace.overarch.domain.views.process-view
...
(defn render-model-node?
  ...
  (let [p (model/parent model e)]
    (contains? el/process-view-element-types (:el e))))
