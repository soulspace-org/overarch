(ns org.soulspace.overarch.domain.views.deployment-architecture-view
...
(defmethod view/render-model-element? :deployment-architecture-view
  [model view e]
  (if (el/model-relation? e)
    (render-model-relation? model view e)
    (render-model-node? model view e)))

(defmethod view/include-content? :deployment-architecture-view
  [model view e]
  (contains? el/deployment-view-element-types (:el e)))

(defmethod view/element-to-render :deployment-architecture-view
  [model view e]
  e)
